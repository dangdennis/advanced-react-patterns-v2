...
class Toggle extends React.Component {
  ...
  static On = ({children}) => (
    <ToggleContext.Consumer>
      {contextValue => {
        if (contextValue.on === undefined) {
          throw new Error('Require { on } context value ')
        }
...
// creating a new `value` object every render and instead passing an object
